...
public class TaskServiceImpl implements TaskService {
	...
	public void saveTaskWithGoogleSync(int projectId, Task task, int loginUserId) throws Exception {
		...
		ce.setUserId(1000);
		googleEvent = googleCalendarService.insertEvent(ce);
	...
	public void deleteTaskWithGoogleSync(int taskId) throws Exception {
		...
		List<CalendarEvent> event = calendarEventService.findCalendarEventByTaskId(taskId);
				...
				try {
					...
					if (updatedEvent != null) {
						...
						if (updatedEvent.getStart() != null) {
							...
							ce.setStartDate(new java.util.Date(startDt.getValue()).toInstant()
						...
						if (updatedEvent.getEnd() != null) {
							...
							ce.setEndDate(new java.util.Date(endDt.getValue()).toInstant()
									.atZone(ZoneId.systemDefault()).toLocalDateTime());
						}
					}
