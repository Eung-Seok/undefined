  ...
  <div class="app">
    <aside class="sidebar">
      ...
      <div class="nav">
        ...
        <a class="active" href="${pageContext.request.contextPath}/employees"><span>👥</span>직원정보</a>
...
<div class="card">
  ...
  <table class="table">
    <thead><tr><th>이름</th><th>직급</th><th>부서</th><th>이메일</th><th></th></tr></thead>
    <tbody>
      <tr><td>홍길동</td><td>사원</td><td>개발</td><td>hong@company.com</td><td><a class="btn" href="${pageContext.request.contextPath}/employees/view">보기</a></td></tr>
      <tr><td>김PM</td><td>과장</td><td>기획</td><td>pm@company.com</td><td><a class="btn" href="${pageContext.request.contextPath}/employees/view">보기</a></td></tr>
    </tbody>
  </table>
</div>
