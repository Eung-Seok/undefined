...
<style>
    ...
    .card { padding: 30px; width: 100%; min-height: 550px; display: block !important; }
    ...
    .btn-edit { color: white; background: #007bff; }
        ...
        <main class="main">
            <div class="card">
                <div style="display: flex; gap: 10px; align-items: center;">
                    <span style="background: #e7f0ff; color: #007bff; padding: 5px 10px; border-radius: 4px;">${post.name}</span>
