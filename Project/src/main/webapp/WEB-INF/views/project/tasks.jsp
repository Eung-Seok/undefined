...
<body data-role="${sessionScope.loginUser.role}">
  <div class="app">
    ...
    <main class="main">
      ...
      <div class="tabs"><a class="tab" href="${pageContext.request.contextPath}/project/overview">개요</a><a class="tab active" href="${pageContext.request.contextPath}/project/tasks">업무</a><a class="tab" href="${pageContext.request.contextPath}/project/calendar">프로젝트 캘린더</a><a class="tab" href="${pageContext.request.contextPath}/project/wbs">WBS</a><a class="tab" href="${pageContext.request.contextPath}/project/issues">이슈</a><a class="tab" href="${pageContext.request.contextPath}/project/docs">문서</a><a class="tab" href="${pageContext.request.contextPath}/project/members">참여자</a><a class="tab" href="${pageContext.request.contextPath}/project/settings">설정</a></div>
...
<div class="card">
  ...
  <div style="display:flex;gap:10px;justify-content:space-between;align-items:center">
    ...
    <button class="btn primary" data-requires="PM,ADMIN" data-action="업무 생성">업무 생성</button>
  </div>
  <div style="height:12px"></div>
  <table class="table">
    <thead><tr><th>업무</th><th>담당</th><th>상태</th><th>마감</th></tr></thead>
    <tbody>
      <tr><td>요구사항 정리</td><td>홍길동</td><td><span class="badge good">진행중</span></td><td>2/13</td></tr>
      <tr><td>WBS 초안 작성</td><td>김PM</td><td><span class="badge warn">대기</span></td><td>2/15</td></tr>
      <tr><td>디자인 리뷰</td><td>디자이너</td><td><span class="badge">완료</span></td><td>2/11</td></tr>
    </tbody>
  </table>
</div>
