...
<body data-role="${sessionScope.loginUser.role}">
  <div class="app">
    ...
    <main class="main">
      ...
      <div class="tabs"><a class="tab" href="${pageContext.request.contextPath}/project/overview">개요</a><a class="tab" href="${pageContext.request.contextPath}/project/tasks">업무</a><a class="tab" href="${pageContext.request.contextPath}/project/calendar">프로젝트 캘린더</a><a class="tab active" href="${pageContext.request.contextPath}/project/wbs">WBS</a><a class="tab" href="${pageContext.request.contextPath}/project/issues">이슈</a><a class="tab" href="${pageContext.request.contextPath}/project/docs">문서</a><a class="tab" href="${pageContext.request.contextPath}/project/members">참여자</a><a class="tab" href="${pageContext.request.contextPath}/project/settings">설정</a></div>

      
<div class="card">
  <h3>WBS</h3>
  <div class="small">엑셀 업로드/다운로드 연동을 붙일 수 있는 화면(데모)</div>
  <div style="height:12px"></div>
  <button class="btn" data-action="WBS 업로드">WBS 업로드</button>
  <button class="btn" data-action="WBS 다운로드" style="margin-left:8px">WBS 다운로드</button>
  <div style="height:12px"></div>
  <table class="table">
    <thead><tr><th>레벨</th><th>작업</th><th>기간</th></tr></thead>
    <tbody>
      <tr><td>1</td><td>기획</td><td>2/1~2/10</td></tr>
      <tr><td>2</td><td>UI 설계</td><td>2/11~2/20</td></tr>
      <tr><td>3</td><td>개발</td><td>2/21~4/10</td></tr>
    </tbody>
  </table>
</div>
