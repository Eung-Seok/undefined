...
<div class="card">
  ...
  <table class="table">
    <thead><tr><th>프로젝트</th><th>상태</th><th>PM</th><th>기간</th><th></th></tr></thead>
    <tbody>
      <tr>
        <td>신규 웹사이트 구축</td>
        ...
        <td><a class="btn" href="${pageContext.request.contextPath}/project/overview">열기</a></td>
      </tr>
      <tr>
        <td>ERP 연동</td>
  ...
  <div style="height:12px"></div>
  <button class="btn primary" data-requires="PM,ADMIN" data-action="프로젝트 생성">프로젝트 생성</button>
</div>
