...
<div class="grid cols-2">
  <div class="card">
    ...
    <table class="table">
      <tbody>
        <tr><th style="width:140px">이름</th><td><c:out value="${sessionScope.loginUser.name}"/></td></tr>
        <tr><th>직급</th><td><c:out value="${sessionScope.loginUser.position}"/></td></tr>
        <tr><th>권한</th><td><c:out value="${sessionScope.loginUser.role}"/></td></tr>
      </tbody>
    </table>
  </div>
  <div class="card">
    ...
    <button class="btn" data-requires="PM,ADMIN" data-action="PM/ADMIN 기능" style="margin-left:8px">PM/ADMIN 기능</button>
    <div style="height:12px"></div>
