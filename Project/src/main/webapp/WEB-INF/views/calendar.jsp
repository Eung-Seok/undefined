...
<div class="grid cols-2">
  <div class="card">
    ...
    <table class="table">
      <thead><tr><th>날짜</th><th>일정</th><th>프로젝트</th></tr></thead>
      <tbody>
        <tr><td>2/13</td><td>킥오프 회의</td><td>신규 웹사이트 구축</td></tr>
        <tr><td>2/15</td><td>API 연동 점검</td><td>ERP 연동</td></tr>
        <tr><td>2/18</td><td>디자인 리뷰</td><td>모바일 앱 개선</td></tr>
      </tbody>
    </table>
  </div>
  <div class="card">
    ...
    <div style="height:12px"></div>
    <button class="btn" data-action="Google Calendar 연결">Google Calendar 연결</button>
    <button class="btn" data-action="Outlook Calendar 연결" style="margin-left:8px">Outlook Calendar 연결</button>
  </div>
</div>
