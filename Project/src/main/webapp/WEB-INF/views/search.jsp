...
<div class="card">
  ...
  <input style="width:100%;padding:10px 12px;border:1px solid var(--line);border-radius:12px" placeholder="검색어를 입력하세요"/>
  <div style="height:12px"></div>
  <table class="table">
    <thead><tr><th>유형</th><th>결과</th><th>링크</th></tr></thead>
    <tbody>
      <tr><td>프로젝트</td><td>신규 웹사이트 구축</td><td><a class="btn" href="${pageContext.request.contextPath}/project/overview">이동</a></td></tr>
      <tr><td>업무</td><td>WBS 초안 작성</td><td><a class="btn" href="${pageContext.request.contextPath}/project/tasks">이동</a></td></tr>
      <tr><td>사용자</td><td>홍길동</td><td><a class="btn" href="${pageContext.request.contextPath}/employees/view">이동</a></td></tr>
    </tbody>
  </table>
</div>
